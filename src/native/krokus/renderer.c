...
HL_PRIM void HL_NAME(renderer_set_clear_color_native) (F32 r, F32 g, F32 b) {
  glClearColor(r, g, b, 1.f);
}

HL_PRIM void HL_NAME(renderer_push_triangle_native) (
  Renderer* renderer,
  F32 x0, F32 y0,
  F32 x2, F32 y1,
  F32 x1, F32 y2,
  ...
  sr_render_push_triangle(&renderer->renderer, sr_vec2(x0, y0), sr_vec2(x1, y1), sr_vec2(x2, y2), sr_vec4(r0, g0, b0, a0), sr_vec4(r1, g1, b1, a1), sr_vec4(r2, g2, b2, a2), sr_vec2(uv0x, uv0y), sr_vec2(uv1x, uv1y), sr_vec2(uv2x, uv2y), texture);
}

HL_PRIM void HL_NAME(renderer_begin_native) (Renderer* renderer) {
  sr_render_begin(&renderer->renderer);
}

HL_PRIM void HL_NAME(renderer_end_native) (Renderer* renderer) {
